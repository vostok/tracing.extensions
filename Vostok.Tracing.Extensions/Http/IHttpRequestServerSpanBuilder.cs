...
namespace Vostok.Tracing.Extensions.Http
{
    ...
    /// <para>See <see cref="IHttpRequestSpanBuilder.SetRequestDetails(System.Uri,string,System.Nullable{long})"/>, <see cref="IHttpRequestSpanBuilder.SetResponseDetails"/> and <see cref="SetClientDetails"/> for more info.</para>
    /// </summary>
    [PublicAPI]
